...
class Surat_model extends CI_Model
{
    ...
    public function list_anggota($id = 0, $nik = 0)
    {
    ...
    public function coba($url = '')
    {
        ...
        if ($individu['rt'][0] !== '0' && $individu['rt'][0] < 10) {
            $individu['rt'] = '0' . $individu['rt'];
        }

        if ($individu['rw'][0] !== '0' && $individu['rw'][0] < 10) {
        ...
        if ($ayah['rt'][0] !== '0' && $ayah['rt'][0] < 10) {
            $ayah['rt'] = '0' . $ayah['rt'];
        }

        if ($ayah['rw'][0] !== '0' && $ayah['rw'][0] < 10) {
            $ayah['rw'] = '0' . $ayah['rw'];
        }
        ...
        if ($ibu['rt'][0] !== '0' && $ibu['rt'][0] < 10) {
            $ibu['rt'] = '0' . $ibu['rt'];
        }

        if ($ibu['rw'][0] !== '0' && $ibu['rw'][0] < 10) {
            $ibu['rw'] = '0' . $ibu['rw'];
        }
