            ...
            <div class="ui-layout-north panel">
                ...
                <div class="left">
                    <div class="uibutton-group">
                        ...
                        <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("analisis_klasifikasi/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o">&nbsp;</span>Hapus Data
                    </div>
                </div>
            </div>
